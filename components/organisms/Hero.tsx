...
export const Hero = () => {
  return (
    <section className="z-10 relative text-zinc-800 font-poppins md:bg-[url('/images/line.svg')] bg-cover bg-bottom bg-no-repeat">
      ...
      />
      <Container className="relative z-10 py-24 lg:pb-48 lg:pt-20 md:flex-row space-y-12">
        <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
          ...
          <div className="flex justify-between space-x-12">
            <Link href={'#mintnft'}>
              <a>
                <PrimaryButton className="px-16">Show Demo</PrimaryButton>
              </a>
            </Link>
            <Link
              href={'https://github.com/nicoburkart/community-pass-contract'}
            >
              <a target="_blank">
        ...
        <div className="relative flex justify-center lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
          <img
            className="hidden md:block -z-10 absolute blur-[70px] -inset-y-20 object-cover object-center rounded"
            alt="hero"
            src="images/blur-hero-2.svg"
          />
          <img
            className="object-cover object-center max-h-[500px] rounded -rotate-6"
            alt="hero"
